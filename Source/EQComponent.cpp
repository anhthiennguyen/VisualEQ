...
void EQComponent::paint (juce::Graphics& g)
{
    ...
    if (show >= 0)
    {
        ...
        txt = "Band " + juce::String(show + 1) + " [" + kTypeNames[typeIdx] + "]"
    ...
    else
    {
        ...
        {
            juce::String bp = "band" + juce::String(i) + "_";
            if (*apvts.getRawParameterValue(bp + "enabled") > 0.5f) ++activeBands;
        }
